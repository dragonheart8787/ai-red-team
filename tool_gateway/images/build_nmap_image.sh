...
#
# The result is a scratch image containing nmap, ncat, their shared libraries
# and nmap's data files. No shell beyond /bin/sh, no package manager, no
# network tooling the tool could use to reconfigure its own namespace.
set -euo pipefail
